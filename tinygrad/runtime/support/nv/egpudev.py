...
class EGPUDev:
    ...
    def __init__(self, devfmt: str, device_id: int = 0):
        ...
        if self.device_info:
            ...
            for i in range(6):  # Check all possible BARs 0-5
                try:
                    ...
                    print(f"   BAR{i}: base=0x{base:x}, size={size} ({'included' if size > 0 else 'skipped'})")
        ...
        print(f"EGPUDev initialized: devfmt={devfmt}, device_id={device_id}, VRAM={self.vram_size} bytes")
