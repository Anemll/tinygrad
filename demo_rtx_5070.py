...
def setup_gpu_environment():
    ...
    # Enable debugging
    os.environ["DEBUG"] = "2"  # Medium debug level
    os.environ["NV_DEBUG"] = "2"  # NVIDIA-specific debug
    print("✓ Set DEBUG=2, NV_DEBUG=2")
...
def test_gpu_performance():
    ...
    try:
        ...
        print("✓ GPU performance test successful")
...
def test_cpu_fallback():
    ...
    try:
        ...
        x = Tensor([1, 2, 3, 4, 5], device="CPU")
        y = x * 2 + 1
        result = y.numpy()
        
        print(f"CPU tensor result: {result}")
...
def main():
    ...
    print("This demo will test GPU acceleration with debugging enabled.")
    print()
    ...
    if passed == total:
        print("🎉 All tests passed! RTX 5070 support is working perfectly!")
    elif passed > 0:
